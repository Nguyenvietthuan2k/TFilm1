...
public class EnterOtpActivity extends AppCompatActivity {
    ...
    String TAG = EnterOtpActivity.class.getName();
    EditText edtOtp;
    Button btnSendOtp;
    FirebaseAuth mAuth;
    ...
    private void initUi() {
        edtOtp = findViewById(R.id.edt_phone_number);
        btnSendOtp = findViewById(R.id.btn_verify_phone_number);
    ...
    private void onClickAgainOtpCode() {
        PhoneAuthOptions phoneAuthOptions =
                PhoneAuthOptions.newBuilder(mAuth)
                        .setPhoneNumber(mPhoneNumber)            // Phone number to verify
                        .setTimeout(60L, TimeUnit.SECONDS)  // Timeout and unit
                        .setActivity(this)
                        .setForceResendingToken(mResendToken)// Activity (for callback binding)
